...
############################################################
# scoreCombinator reference — set by playgroundcontroller, null on regular dashboard
...
############################################################
# Dynamic param accessors — live model when available, defaults otherwise
getDiffParams = -> if scoreCombinator? then scoreCombinator.getDiffParams() else defaultDiffParams
getFinalWeights = -> if scoreCombinator? then scoreCombinator.getFinalWeights() else defaultFinalWeights
...
############################################################
export setScoreCombinator = (model) -> scoreCombinator = model
export getScoreCombinator = -> scoreCombinator
