...
## Main Components
- `cotnorm-el` display of the special normalization params and results for the COTs per Area
...
- `mrrnorm-el` display of the special linear normalization params and results for the interest rate
